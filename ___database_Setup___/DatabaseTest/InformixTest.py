...
necesito reescribir esto para que el GetStructure que ya existe se convierta en GetStructureReportes() y necesito generar una funcion que se llame GetArticleData() que utilizando informix obtenga la data del articulo, un articulo tiene esta configuracion de la base de datos:     art_articu char(15) not null, CODIGO DE ARTICULO (1) 
...
yo los datos que necesito son solo, el codigo de articulo, la descripcion###